...
const DashboardError = ({ message, onRetry, isRetrying }) => {
  return (
    <div
      className="max-w-md mx-auto my-16 p-6 sm:p-8 bg-white rounded-2xl border border-gray-200 shadow-xs text-center space-y-4"
      role="alert"
    >
